        ...
        public ActionResult Upload(HttpPostedFileBase file)
        {
            if (file != null)
            {
                if (ValidateFile(file))
                {
                    ...
                    {
                        ModelState.AddModelError("FileName", "Error occured");
                    }
                }
                else
                {
                    ModelState.AddModelError("FileName", "file must be this format");
                }
            }
            else
            {
                ModelState.AddModelError("FileName", "Choose file");
            }
